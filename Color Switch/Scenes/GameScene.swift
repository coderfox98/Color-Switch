...
class GameScene: SKScene {
    ...
    private func layoutScene() {
        ...
        colorSwitch.zPosition = ZPositons.colorSwitch
        colorSwitch.physicsBody = SKPhysicsBody(circleOfRadius: colorSwitch.frame.height / 2)
        ...
        scoreLabel.zPosition = ZPositons.label
    ...
    func gameOver() {
        ...
        view?.presentScene(menuScene, transition: .push(with: .up, duration: 0.3))
    }
